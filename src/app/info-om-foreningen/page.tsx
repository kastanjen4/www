    ...
    <PageContent>
      <Section className="prose dark:prose-invert">
        ...
        <p>
          ...
          Centralstationen. Till Centralstationen är det
          &ldquo;gångavstånd&rdquo; på 20-25 min. Orkar man inte gå så finns
          utmärkta bussförbindelser precis runtom oss.
        </p>
        <p>
          Både Folkets park och Triangeln är knytpunkter för stadsbussarna, och
          på bergsgatan, som korsar Almbacksgatan 50m från vår port, ligger
